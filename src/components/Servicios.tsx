...
export default function Servicios() {
    const handleServiceClick = (serviceName: string): void => {
        ...
        window.open(`https://wa.me/593995832788?text=¡Hola!%20Me%20interesa%20información%20sobre%20${encodeURIComponent(serviceName)}`, '_blank');
    };

    const handleConsultaClick = (): void => {
        if (typeof window !== "undefined" && window.gtag) {
        ...
        <section id="servicios" className="py-16 bg-gradient-to-br from-blue-50 to-green-50">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
                    {servicios.map((servicio: Service, index: number) => {
                            ...
                            <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group hover:scale-[1.02] h-full">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="space-y-2 mb-4">
                                        {servicio.benefits.map((benefit: string, idx: number) => (
                            ...
                            <div key={index} className="relative">
                                {servicio.link ? (
                                    ...
                                    <div 
                                        ...
                                        onClick={() => handleServiceClick(servicio.nombre)}
                                    >
                                        {CardContent}
                                    </div>
                                )}
