...
export default function DoctorDePiesQuitoLanding() {
  ...
  const businessSchema = {
    ...
    "areaServed": [
      {"@type": "City", "name": "Quito Norte, Ecuador"},
      {"@type": "City", "name": "La Florida, Quito"},
      {"@type": "City", "name": "Iñaquito, Quito"},
      {"@type": "City", "name": "Rumipamba, Quito"},
      {"@type": "State", "name": "Pichincha, Ecuador"}
    ],
    "serviceArea": {
      "@type": "GeoCircle",
      "geoMidpoint": {"@type": "GeoCoordinates", "latitude": "-0.1807", "longitude": "-78.4678"},
      "geoRadius": "20000"
    },
    "founder": {
      "@type": "Physician",
      ...
      "worksFor": {"@type": "MedicalClinic", "name": "PodoClinic"},
      "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "Medical License", "recognizedBy": {"@type": "Organization", "name": "Ministerio de Salud Pública Ecuador"}}],
      "medicalSpecialty": ["Podiatry", "Diabetic Foot Care", "Nail Disorders", "Sports Podiatry"],
      "yearsExperience": "10+"
    },
    "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.9", "reviewCount": "312", "bestRating": "5", "worstRating": "1"},
    "medicalSpecialty": ["Podiatry", "Diabetic Foot Care", "Ingrown Nail Treatment", "Plantar Wart Removal", "Foot Prophylaxis"],
    "availableService": [
      {"@type": "MedicalProcedure", "name": "Tratamiento de Uñeros", "alternateName": "Uñas Encarnadas", "description": "Tratamiento sin dolor para uñeros con recuperación en 24-48 horas"},
      {"@type": "MedicalProcedure", "name": "Cuidado Pie Diabético", "description": "Atención especializada para prevenir complicaciones en pacientes diabéticos"},
      {"@type": "MedicalProcedure", "name": "Profilaxis Podal", "description": "Limpieza profunda, corte de uñas, eliminación de callosidades"},
      {"@type": "MedicalProcedure", "name": "Tratamiento de Hongos", "alternateName": "Onicomicosis", "description": "Eliminación de hongos en uñas y pies con productos especializados"},
      {"@type": "MedicalProcedure", "name": "Verrugas Plantares", "description": "Cauterización profesional para eliminar verrugas plantares"},
      {"@type": "MedicalService", "name": "Atención Domicilio", "description": "Servicio de podología a domicilio sin costo adicional en Quito Norte"}
    ],
    "paymentAccepted": ["Cash", "Credit Card", "Debit Card"],
    "currenciesAccepted": "USD",
    "smokingAllowed": false,
    "petsAllowed": false,
    "hasOfferCatalog": {"@type": "OfferCatalog", "name": "Servicios de Podología", "itemListElement": [
      {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Consulta Inicial Gratuita"}, "price": "0", "priceCurrency": "USD"},
      {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Tratamiento de Uñeros"}, "price": "15", "priceCurrency": "USD"}
    ]},
    "sameAs": [
      "https://www.facebook.com/podoclinic.cm",
      "https://www.instagram.com/podoclinic.ec/",
