    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 flex flex-col items-center">
          <CTAButton 
            href="https://wa.me/593995832788?text=¡Hola!%20Quiero%20agendar%20podología%20en%20La%20Florida%20Quito%20norte"
            ...
            trackingLabel="agendar_la_florida"
            isExternal={true}
          >
            Agendar Podología en La Florida
          </CTAButton>
        </div>
      </article>
      <WhatsAppButton />
