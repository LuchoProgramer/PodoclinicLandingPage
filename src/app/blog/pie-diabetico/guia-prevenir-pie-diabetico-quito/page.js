    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 flex flex-col items-center">
          <CTAButton text="Agendar Consulta Pie Diabético" link="https://wa.me/593995832788?text=¡Hola!%20Quiero%20agendar%20consulta%20para%20pie%20diabético%20a%20domicilio" />
        </div>
      </article>
      <WhatsAppButton />
    </div>
