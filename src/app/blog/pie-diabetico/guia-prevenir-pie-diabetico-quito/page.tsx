...
export const metadata = {
  title: "Guía Paso a Paso para Prevenir el Pie Diabético en Quito | Consejos de Cristina Muñoz, Podóloga Especialista",
  description: "Prevención de pie diabético en Quito: consejos, señales de alerta y atención podológica a domicilio por Cristina Muñoz, Podóloga Especialista.",
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg mx-auto text-gray-800">
          ...
          <ul>
            ...
            <li><strong>¿Cuánto tarda el cuidado preventivo?</strong> Una consulta de una hora puede prevenir problemas graves. Cristina Muñoz te guía desde el primer día.</li>
          </ul>
        </div>
        {/* CTA principal */}
