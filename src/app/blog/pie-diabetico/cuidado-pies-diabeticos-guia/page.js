    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 flex flex-col items-center">
          <CTAButton text="Evaluación Especializada Pie Diabético" link="https://wa.me/593995832788?text=¡Hola%20Dra.%20Cristina!%20Soy%20diabético%20y%20necesito%20evaluación%20especializada%20de%20mis%20pies" />
        </div>
      </article>
      <WhatsAppButton />
    </div>
