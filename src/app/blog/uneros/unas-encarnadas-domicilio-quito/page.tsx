  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lava con agua tibia y jabón neutro, aplica crema antibiótica y usa zapatos sueltos. Para un alivio real, confía en Podoclinicec a domicilio desde $35."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "En Podoclinicec, la primera consulta a domicilio es desde $35, con tratamiento y tips incluidos. Llama ya: +593995832788."
      }
    },
    {
      "@type": "Question",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg mx-auto text-gray-800">
          ...
          <p>Imagina esto: no tienes que moverte de tu casa en Quito norte. En Podoclinicec, Cristina Muñoz, Podóloga Especialista, nuestra experta en podología, llega a ti con todo lo necesario para aliviar tus uñas encarnadas. Desde $35, tu primera consulta a domicilio incluye:</p>
          <ul>
          ...
          <ul>
            <li><strong>¿Cómo aliviar una uña encarnada en casa?</strong> Lava con agua tibia y jabón neutro, aplica una crema antibiótica y usa zapatos sueltos. Pero para un alivio real, confía en Podoclinicec a domicilio desde $35.</li>
            <li><strong>¿Cuánto cuesta tratar uñas encarnadas en Quito?</strong> En Podoclinicec, la primera consulta a domicilio es desde $35, con tratamiento y tips incluidos. ¡Llama ya!</li>
