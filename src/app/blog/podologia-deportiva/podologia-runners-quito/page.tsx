...
export const metadata = {
  ...
  description: "Podología deportiva para runners en Quito: prevención de lesiones y tratamiento profesional con Cristina Muñoz, Podóloga Especialista.",
    ...
    <LayoutClient>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Prevención, recuperación y consejos profesionales para corredores. Servicio a domicilio en Quito norte con Cristina Muñoz, Podóloga Especialista.
              </p>
            </div>
        ...
        <article className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="prose prose-lg mx-auto text-gray-800 text-justify">
            <figure className="mb-8">
              <img
                src="https://images.pexels.com/photos/601177/pexels-photo-601177.jpeg?auto=compress&w=900&q=80"
                alt="Mujer atando sus zapatos deportivos Nike gris y rosa"
                className="w-full h-96 object-cover rounded-xl shadow-lg"
                loading="lazy"
              />
              <figcaption className="text-center text-sm text-gray-500 mt-2">Foto de Tirachard Kumtanom en Pexels</figcaption>
            </figure>
            ...
            <figure className="my-8">
              <img
                src="https://images.pexels.com/photos/3756165/pexels-photo-3756165.jpeg?auto=compress&w=900&q=80"
                alt="Corredor de pie en la pista de atletismo"
                className="w-full h-80 object-cover rounded-xl shadow-lg"
                loading="lazy"
              />
              <figcaption className="text-center text-sm text-gray-500 mt-2">Foto de Andrea Piacquadio en Pexels</figcaption>
            </figure>
            <h2>Problemas Comunes en Runners</h2>
            <figure className="my-8">
              <img
                src="https://images.pexels.com/photos/12659352/pexels-photo-12659352.jpeg?auto=compress&w=900&q=80"
                alt="Gente, zapatos de deporte, corredor"
                className="w-full h-80 object-cover rounded-xl shadow-lg"
                loading="lazy"
              />
              <figcaption className="text-center text-sm text-gray-500 mt-2">Foto de BOOM 💥 en Pexels</figcaption>
            </figure>
            <ul>
            ...
            <p>Imagina: estás en casa, Cristina Muñoz llega con equipos esterilizados, y en una hora tus pies están listos para la próxima carrera. ¿No es una aventura que vale la pena?</p>
            ...
            <p>¿Quieres más tips personalizados? Cristina Muñoz te los da en tu consulta.</p>
            ...
            <ul>
              ...
              <li><strong>¿Cuánto tarda una consulta?</strong> Una hora, con resultados desde el primer día. Cristina Muñoz te prepara para correr sin límites.</li>
            </ul>
          </div>
          {/* CTA principal */}
          <div className="mt-12 flex flex-col items-center">
            <CTAButton 
              href="https://wa.me/593995832788?text=¡Hola!%20Quiero%20agendar%20consulta%20de%20podología%20deportiva%20a%20domicilio"
              ...
              trackingLabel="consulta_podologia_deportiva"
              isExternal={true}
            >
              Agendar Consulta Podología Deportiva
            </CTAButton>
          </div>
        </article>
        <WhatsAppButton />
