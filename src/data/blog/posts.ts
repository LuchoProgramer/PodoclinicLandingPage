...
export const blogPosts: BlogPost[] = [
  {
    ...
    slug: "podologia-domicilio-quito-norte",
      excerpt: "¿Quieres podología profesional en tu casa? Descubre cómo Cristina Muñoz cuida tus pies en Quito norte desde $35. Comodidad, seguridad y experiencia a domicilio.",
    content: ``,
    category: "local",
    ...
    metaTitle: "Podología a Domicilio en Quito Norte | Cristina Muñoz",
      metaDescription: "Podología a domicilio en Quito norte con Cristina Muñoz. Atención profesional, segura y económica en tu casa desde $35.",
  ...
  },
  {
    ...
    slug: "guia-prevenir-pie-diabetico-quito",
      excerpt: "¿Sabías que el pie diabético es más común de lo que crees en Quito? Aprende a prevenirlo y cuida tus pies con Cristina Muñoz a domicilio desde $35.",
    content: ``,
    ...
    metaTitle: "Guía para Prevenir Pie Diabético en Quito | Podoclinicec",
      metaDescription: "Prevención de pie diabético en Quito: consejos prácticos y atención a domicilio por Cristina Muñoz desde $35.",
    featured: true,
    cta: {
  ...
  },
  {
    ...
    slug: "podologia-runners-quito",
      excerpt: "¿Listo para volar en la Quito 15K, pero un dolor en los pies te frena? Descubre cómo Cristina Muñoz cuida a los runners de Quito norte a domicilio desde $35.",
    content: ``,
    ...
    metaTitle: "Podología para Runners en Quito | Podoclinicec",
      metaDescription: "Podología deportiva a domicilio en Quito norte con Cristina Muñoz. Prevención y tratamiento de lesiones para runners desde $35.",
    featured: true,
    cta: {
  ...
  },
  {
    ...
    slug: "podologo-la-florida-quito-norte",
      excerpt: "¿Buscas un podólogo cerca de casa? Descubre por qué Podoclinicec en La Floreida, Quito norte, es la mejor opción para runners, diabéticos y familias. Atención a domicilio desde $35.",
    content: ``,
    category: "local",
    author: "Cristina Muñoz",
    publishDate: "2025-10-08",
    ...
    metaTitle: "Podólogo en La Florida Quito Norte | Podoclinicec",
      metaDescription: "Podología a domicilio en La Florida, Quito norte, con Cristina Muñoz. Atención profesional, segura y económica en tu casa desde $35.",
    featured: true,
    cta: {
  ...
  },
  {
    ...
    slug: "faq-podologia-domicilio-quito",
      excerpt: "Resuelve todas tus dudas sobre podología a domicilio en Quito norte con Cristina Muñoz. Atención profesional, segura y económica en tu casa desde $35.",
    content: ``,
    category: "uneros",
    author: "Cristina Muñoz",
    publishDate: "2025-10-08",
    ...
    metaTitle: "Preguntas Frecuentes Podología a Domicilio Quito | Podoclinicec",
      metaDescription: "Podología a domicilio en Quito norte: atención profesional, segura y económica en tu casa por Cristina Muñoz desde $35.",
    featured: true,
    cta: {
      text: "Agendar Podología a Domicilio",
      link: "https://wa.me/593995832788?text=¡Hola!%20Quiero%20agendar%20podología%20a%20domicilio%20en%20Quito%20norte"
  ...
  },
  {
    ...
    slug: "unas-encarnadas-domicilio-quito",
      excerpt: "¿Uñero en Quito norte? Descubre cómo Cristina Muñoz te alivia en casa desde $35. Consejos, prevención y atención profesional a domicilio.",
    content: ``,
    category: "uneros",
    author: "Cristina Muñoz",
    publishDate: "2025-10-08",
    ...
    metaTitle: "Uñas Encarnadas a Domicilio en Quito | Cristina Muñoz",
      metaDescription: "Tratamiento profesional de uñas encarnadas a domicilio en Quito norte. Alivio rápido, seguro y económico con Cristina Muñoz desde $35.",
    featured: true,
    cta: {
